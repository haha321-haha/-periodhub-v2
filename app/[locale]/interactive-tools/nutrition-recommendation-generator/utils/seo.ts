...
export const seoConfig = {
  ...
  base: {
    ...
    description:
      "Professional nutrition suggestion generator based on your menstrual cycle, health goals, and TCM constitution. Combines modern nutrition science with traditional Chinese medicine.",
    keywords:
  ...
  zh: {
    ...
    description:
      "专业的营养推荐生成器，基于您的月经周期、健康目标和中医体质，提供个性化的饮食指导。科学结合现代营养学与中医理论。",
    keywords:
      "营养推荐生成器,月经周期营养,中医体质饮食,个性化营养方案,女性健康饮食,经期营养管理,痛经营养调理,中医食疗",
  },
