...
export default function StressTechniquesAccordion({
  ...
  const getStartLink = (techniqueKey: string) => {
    if (techniqueKey === "breathing") {
      return `/${locale}/interactive-tools/stress-management/breathing-exercise`;
    }
    // 其他技巧暂时链接到techniques页面
    return `/${locale}/interactive-tools/stress-management/techniques/${techniqueKey}`;
  };
