...
export class CyclePredictor {
   ...
   * 预测未来几个月的周期
   */
  public predictFutureCycles(periodData: PeriodRecord[], months: number = 3): {
    date: string;
   ...
   * 计算经期长度
   */
  private calculatePeriodLengths(periods: Array<{ startDate: string; endDate: string; records: PeriodRecord[] }>): number[] {
