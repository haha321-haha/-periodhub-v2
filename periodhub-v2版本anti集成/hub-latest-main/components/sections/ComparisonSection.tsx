...
import { Clock, Pill, Leaf, AlertCircle, CheckCircle, ArrowRight } from 'lucide-react';
        ...
        <div className="flex-1 bg-gray-50 rounded-3xl p-8 border border-gray-200 relative overflow-hidden group hover:shadow-lg transition-all">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 text-gray-500 mb-4">
              ...
              <span className="font-semibold tracking-wide uppercase text-sm">{t('pills.title')}</span>
            </div>
        ...
        <div className="flex-1 bg-gradient-to-br from-purple-600 to-pink-500 rounded-3xl p-8 text-white relative overflow-hidden shadow-xl transform md:scale-105 z-0">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 text-purple-100 mb-4">
              ...
              <span className="font-semibold tracking-wide uppercase text-sm">{t('natural.title')}</span>
            </div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-lg">{t('natural.duration')}</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="bg-white/20 p-1 rounded-full">
            ...
            <Link href={`/${locale}/immediate-relief`} className="inline-flex items-center justify-center w-full py-3 bg-white text-purple-600 rounded-xl font-bold hover:bg-purple-50 transition-colors">
