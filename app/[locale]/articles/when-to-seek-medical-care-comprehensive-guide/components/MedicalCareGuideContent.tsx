  ...
  return (
    <div className="container-custom py-8 md:py-12">
      ...
      <main className="max-w-4xl mx-auto space-y-8 md:space-y-12" role="main" aria-label="医疗护理指南主要内容">
        ...
        {/* 文章头部 */}
        <header role="banner" aria-label="文章标题区域" className="text-center mb-8">
          <h1 id="main-title" className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4 tracking-tight">
            {t('header.title')}
          </h1>
        ...
        {/* 导言部分 */}
        <section role="region" aria-labelledby="introduction-title" className="bg-white p-4 md:p-6 rounded-2xl shadow-lg mb-8 hover:shadow-xl transition-all duration-300">
          <h2 id="introduction-title" className="text-xl md:text-2xl font-bold text-rose-800 mb-6 flex items-center gap-3">
            <svg className="w-6 h-6 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <span>{t('article.section1.title')}</span>
          </h2>
          <p className="text-sm text-gray-700 mb-3">{t('article.section1.p1')}</p>
          <p className="text-sm text-gray-700 mb-3">{t('article.section1.p2')}</p>
          <p className="text-sm text-gray-700 mb-3">{t('article.section1.p3')}</p>
          <ul className="list-disc pl-5 space-y-2 leading-relaxed mb-3">
            <li className="text-sm text-gray-700">{t('article.section1.li1')}</li>
            <li className="text-sm text-gray-700">{t('article.section1.li2')}</li>
            <li className="text-sm text-gray-700">{t('article.section1.li3')}</li>
            <li className="text-sm text-gray-700">{t('article.section1.li4')}</li>
          </ul>
        ...
        {/* 疼痛量化部分 */}
        <section role="region" aria-labelledby="pain-assessment-title" className="bg-white p-4 md:p-6 rounded-2xl shadow-lg mb-8 hover:shadow-xl transition-all duration-300">
          <h2 id="pain-assessment-title" className="text-xl md:text-2xl font-bold text-rose-800 mb-6 flex items-center gap-3">
            <svg className="w-6 h-6 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
            <span>{t('article.section2.title')}</span>
          </h2>
          <p className="text-sm text-gray-700 mb-3">{t('article.section2.p1')}</p>
          <p className="text-sm text-gray-700 mb-3">{t('article.section2.p2')}</p>
        ...
        {/* 危险信号部分 */}
        <section role="region" aria-labelledby="warning-signs-title" className="bg-white p-4 md:p-6 rounded-2xl shadow-lg mb-8 hover:shadow-xl transition-all duration-300">
          <h2 id="warning-signs-title" className="text-xl md:text-2xl font-bold text-rose-800 mb-6 flex items-center gap-3">
            <svg className="w-6 h-6 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
            <div className="p-3 bg-rose-50 border border-rose-200 rounded-lg hover:bg-rose-100 hover:border-rose-300 transition-all duration-300 hover:scale-105">
              <div className="flex items-center justify-center w-8 h-8 bg-rose-100 text-rose-600 font-bold text-sm rounded-full mx-auto mb-3">1</div>
              <h3 className="font-bold text-sm text-rose-700 mb-2">{t('article.section3.h3_1')}</h3>
        ...
        {/* 决策树部分 */}
        <section role="region" aria-labelledby="decision-tree-title" className="bg-white p-4 md:p-6 rounded-2xl shadow-lg mb-8 hover:shadow-xl transition-all duration-300">
          <h2 id="decision-tree-title" className="text-xl md:text-2xl font-bold text-rose-800 mb-6 flex items-center gap-3">
            <svg className="w-6 h-6 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* 总结部分 */}
        <section role="region" aria-labelledby="summary-title" className="bg-white p-4 md:p-6 rounded-2xl shadow-lg mb-8 hover:shadow-xl transition-all duration-300">
          <h2 id="summary-title" className="text-xl md:text-2xl font-bold text-rose-800 mb-6 flex items-center gap-3">
            <svg className="w-6 h-6 text-rose-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
