...
export type AnchorTextKey<T extends AnchorTextSection> = keyof typeof ANCHOR_TEXTS[T];
...
export function getAnchorTextStats() {
  return {
    ...ANCHOR_TEXT_STATS,
    keywordDensityPercentage: Math.round(ANCHOR_TEXT_STATS.keywordDensity * 100),
