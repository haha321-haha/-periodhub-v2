      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardFooter>
              <Link href="/interactive-tools/symptom-assessment" className="w-full">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardFooter>
              <Link href="/interactive-tools/nutrition-recommendation-generator" className="w-full">
                <Button className="w-full">
                  {t('cards.reports.cta')}
                </Button>
              </Link>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-purple-50 rounded-lg">
                ...
                <div className="text-sm text-purple-600">{t('stats.assessments')}</div>
              </div>
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                <div className="text-2xl font-bold text-blue-600">0</div>
                <div className="text-sm text-blue-600">{t('stats.trackedDays')}</div>
              </div>
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <div className="text-2xl font-bold text-green-600">0</div>
                <div className="text-sm text-green-600">{t('stats.reports')}</div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-semibold text-green-800">
                    订阅类型: {subscriptionStatus.type === 'one_time' ? '一次性购买' : '订阅'}
                  </p>
                  <p className="text-sm text-green-600">
                    状态: {subscriptionStatus.status === 'active' ? '激活' : subscriptionStatus.status}
                  </p>
                </div>
