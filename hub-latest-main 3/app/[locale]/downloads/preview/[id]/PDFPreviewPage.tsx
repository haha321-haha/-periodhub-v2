...
import { getPreviewContentById, type PreviewContent } from '@/config/previewContent';
          ...
          <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-6">
                {previewSections.map((section: { title: string; content: string[]; isHighlight?: boolean }, index: number) => (
