...
export function calculateSymptomImpact(
  ...
  if (painLevel === "mild") {
    (recommendations.immediate as any[]).push(
      ...(recommendationTexts[locale as keyof typeof recommendationTexts].mild
        .immediate as any),
    );
    ...
    (recommendations.immediate as any[]).push(
      ...(recommendationTexts[locale as keyof typeof recommendationTexts]
        .moderate.immediate as any),
    );
    (recommendations.longTerm as any[]).push(
      ...(recommendationTexts[locale as keyof typeof recommendationTexts]
        .moderate.longTerm as any),
    );
  } else {
    // severe or verySevere
    (recommendations.immediate as any[]).push(
      ...(recommendationTexts[locale as keyof typeof recommendationTexts].severe
        .immediate as any),
    );
    (recommendations.longTerm as any[]).push(
      ...(recommendationTexts[locale as keyof typeof recommendationTexts].severe
  ...
  if (reliefPreference === "natural") {
    (recommendations.immediate as any[]).unshift(
      ...(recommendationTexts[locale as keyof typeof recommendationTexts]
        .natural.immediate as any),
    );
    (recommendations.longTerm as any[]).push(
      ...(recommendationTexts[locale as keyof typeof recommendationTexts]
        .natural.longTerm as any),
    );
  }
  if (reliefPreference === "medical") {
    (recommendations.longTerm as any[]).unshift(
      ...(recommendationTexts[locale as keyof typeof recommendationTexts]
        .medical.longTerm as any),
    );
  }
