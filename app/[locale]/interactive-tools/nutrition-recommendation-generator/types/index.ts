...
// 中医体质数据接口
export interface TCMConstitutionData {
...
export interface UserSelections {
  ...
  tcmConstitution: Set<TCMConstitution>;
}
...
export interface RecommendationResult {
  ...
  tcmConstitution: TCMConstitutionData[];
...
export interface UseNutritionDataReturn {
  ...
  tcmConstitutionData: TCMConstitutionData[];
  isLoading: boolean;
  error: string | null;
}
