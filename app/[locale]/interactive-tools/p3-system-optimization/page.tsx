...
export default function P3Phase({ locale }: P3PhaseProps) {
  ...
  const p3Tasks = [
    {
      id: 'i18n',
      title: locale === 'zh' ? '国际化完善' : 'Internationalization Enhancement',
      description: locale === 'zh' ? '完善翻译质量，优化多语言支持' : 'Improve translation quality and optimize multilingual support',
      icon: Globe,
      color: 'blue',
    ...
    },
    {
      ...
      description: locale === 'zh' ? '提升应用性能，优化用户体验' : 'Improve application performance and user experience',
      icon: Zap,
      color: 'yellow',
      status: 'completed' as const,
      progress: 100
    },
    {
      ...
      description: locale === 'zh' ? '全面的测试覆盖，确保代码质量' : 'Comprehensive test coverage ensuring code quality',
      icon: TestTube,
      color: 'purple',
      status: 'completed' as const,
      progress: 100
    },
    {
      ...
      description: locale === 'zh' ? '完善的文档体系，提升开发效率' : 'Comprehensive documentation system to improve development efficiency',
      icon: BookOpen,
      color: 'indigo',
      status: 'completed' as const,
      progress: 100
