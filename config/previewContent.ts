  ...
  'teacher-health-manual': {
    ...
    keyPoints: {
      ...
      en: [
        ...
        'Identification of students with menstrual discomfort',
    ...
    useCase: {
      zh: '教师处理学生经期不适情况',
      en: 'Teachers handling students\' menstrual discomfort'
    },
    estimatedTime: {
      zh: '8-12分钟',
      en: '8-12 minutes'
      ...
      en: [
        {
          ...
          content: [
            'Common manifestations of menstrual discomfort',
            'Methods for assessing pain levels',
            'Criteria for judging emergency situations',
            'Student privacy protection principles'
          ],
          isHighlight: true
        },
        {
    ...
    fullVersionIncludes: {
      ...
      en: [
        'Detailed symptom identification guide',
        'Emergency handling flow chart',
        'Medical referral standards',
        'Student file management methods',
        'Teacher training materials',
        'School policy development suggestions'
      ]
    }
  },
 ...
 * 根据资源ID获取预览内容
 */
export function getPreviewContentById(resourceId: string): PreviewContent | undefined {
