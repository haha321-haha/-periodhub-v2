...
export default function PartnerHandbookClient({ locale }: PartnerHandbookClientProps) {
  ...
  const isStageUnlockedSafe = (stage: 'stage2' | 'stage3' | 'stage4'): boolean => {
    if (!isClient) {
  ...
  const handleClearAllData = () => {
    if (confirm(locale === 'zh' ? '确定要清除所有测试数据吗？这将重置所有进度。' : 'Are you sure you want to clear all test data? This will reset all progress.')) {
      clearAllTestData();
      // 刷新页面以确保状态完全重置
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
                ...
                >
                  ...
                  <div className="text-xs text-gray-500 mb-3">
                    {t('quiz.stages.stage1.timeLimit')} • {t('quiz.stages.stage1.difficulty')}
                  </div>
                  <div className="flex items-center text-primary-600 font-medium group-hover:text-primary-700 transition-colors text-sm sm:text-base">
                    <span className="mr-2">{t('quiz.stages.stage1.buttonText')}</span>
                ...
                >
                  <div className={`w-12 sm:w-16 h-12 sm:h-16 flex items-center justify-center rounded-full mb-4 sm:mb-6 transition-transform duration-300 ${
                    isStageUnlockedSafe('stage2') ? 'bg-blue-50 text-blue-600 group-hover:scale-110' : 'bg-gray-100 text-gray-400'
                  }`}>
                    <svg className="w-6 sm:w-8 h-6 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h3 className={`text-lg sm:text-xl font-semibold mb-2 sm:mb-3 transition-colors ${
                    isStageUnlockedSafe('stage2') ? 'text-neutral-800 group-hover:text-primary-700' : 'text-gray-500'
                  }`}>
                    {t('quiz.stages.stage2.title')}
                  </h3>
                  <p className={`mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base ${
                    isStageUnlockedSafe('stage2') ? 'text-neutral-600' : 'text-gray-400'
                  }`}>
                    {t('quiz.stages.stage2.description')}
                  </p>
                  <div className={`text-xs mb-3 ${
                    isStageUnlockedSafe('stage2') ? 'text-gray-500' : 'text-gray-400'
                  }`}>
                    {t('quiz.stages.stage2.timeLimit')} • {t('quiz.stages.stage2.difficulty')}
                  </div>
                  <div className={`font-medium text-sm sm:text-base ${
                    isStageUnlockedSafe('stage2') ? 'text-primary-600 group-hover:text-primary-700' : 'text-gray-400'
                  }`}>
                ...
                >
                  <div className={`w-12 sm:w-16 h-12 sm:h-16 flex items-center justify-center rounded-full mb-4 sm:mb-6 transition-transform duration-300 ${
                    isStageUnlockedSafe('stage3') ? 'bg-pink-50 text-pink-600 group-hover:scale-110' : 'bg-gray-100 text-gray-400'
                  }`}>
                    <svg className="w-6 sm:w-8 h-6 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h3 className={`text-lg sm:text-xl font-semibold mb-2 sm:mb-3 transition-colors ${
                    isStageUnlockedSafe('stage3') ? 'text-neutral-800 group-hover:text-primary-700' : 'text-gray-500'
                  }`}>
                    {t('quiz.stages.stage3.title')}
                  </h3>
                  <p className={`mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base ${
                    isStageUnlockedSafe('stage3') ? 'text-neutral-600' : 'text-gray-400'
                  }`}>
                    {t('quiz.stages.stage3.description')}
                  </p>
                  <div className={`text-xs mb-3 ${
                    isStageUnlockedSafe('stage3') ? 'text-gray-500' : 'text-gray-400'
                  }`}>
                    {t('quiz.stages.stage3.timeLimit')} • {t('quiz.stages.stage3.difficulty')}
                  </div>
                  <div className={`font-medium text-sm sm:text-base ${
                    isStageUnlockedSafe('stage3') ? 'text-primary-600 group-hover:text-primary-700' : 'text-gray-400'
                  }`}>
                ...
                >
                  <div className={`w-12 sm:w-16 h-12 sm:h-16 flex items-center justify-center rounded-full mb-4 sm:mb-6 transition-transform duration-300 ${
                    isStageUnlockedSafe('stage4') ? 'bg-green-50 text-green-600 group-hover:scale-110' : 'bg-gray-100 text-gray-400'
                  }`}>
                    <svg className="w-6 sm:w-8 h-6 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h3 className={`text-lg sm:text-xl font-semibold mb-2 sm:mb-3 transition-colors ${
                    isStageUnlockedSafe('stage4') ? 'text-neutral-800 group-hover:text-primary-700' : 'text-gray-500'
                  }`}>
                    {t('quiz.stages.stage4.title')}
                  </h3>
                  <p className={`mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base ${
                    isStageUnlockedSafe('stage4') ? 'text-neutral-600' : 'text-gray-400'
                  }`}>
                    {t('quiz.stages.stage4.description')}
                  </p>
                  <div className={`text-xs mb-3 ${
                    isStageUnlockedSafe('stage4') ? 'text-gray-500' : 'text-gray-400'
                  }`}>
                    {t('quiz.stages.stage4.timeLimit')} • {t('quiz.stages.stage4.difficulty')}
                  </div>
                  <div className={`font-medium text-sm sm:text-base ${
                    isStageUnlockedSafe('stage4') ? 'text-primary-600 group-hover:text-primary-700' : 'text-gray-400'
                  }`}>
                    {isStageUnlockedSafe('stage4') ? t('quiz.stages.stage4.buttonText') : t('quiz.stages.stage4.unlockCondition')}
                  </div>
                </button>
              </div>
            </section>
