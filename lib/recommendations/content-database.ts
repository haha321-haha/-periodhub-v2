...
export class RecommendationContentDatabase {
    ...
    const exerciseContents: RecommendationContent[] = [
      {
        ...
        actionSteps: [
          { zh: "猫牛式：跪姿，脊柱缓慢起伏，重复5-8次", en: "Cat-Cow: Kneeling position, slowly arch and round spine, repeat 5-8 times" },
          { zh: "婴儿式：跪姿，身体前倾，额头贴地，保持30秒", en: "Child's Pose: Kneeling, fold forward, forehead to ground, hold 30 seconds" },
          { zh: "蝴蝶式：坐姿，脚底相对，轻柔上下摆动膝盖", en: "Butterfly Pose: Sitting, soles together, gently flap knees up and down" },
          { zh: "躺姿扭转：仰卧，双膝弯曲，左右轻柔扭转", en: "Supine Twist: Lying on back, knees bent, gentle side-to-side twists" }
        ],
        priority: "medium",
        ...
        resources: [
          {
            ...
            title: { zh: "经期瑜伽完整视频教程", en: "Complete Menstrual Yoga Video Tutorial" },
            description: { zh: "15分钟经期瑜伽跟练视频", en: "15-minute guided menstrual yoga video" },
            type: "video",
      ...
      },
      {
        ...
        actionSteps: [
          { zh: "经期：每日20-30分钟轻松步行", en: "Menstrual: 20-30 minutes easy walking daily" },
          { zh: "卵泡期：增加到30-45分钟中等强度步行", en: "Follicular: Increase to 30-45 minutes moderate walking" },
          { zh: "排卵期：保持45分钟，可加入轻度坡度", en: "Ovulation: Maintain 45 minutes, can add gentle inclines" },
          { zh: "黄体期：回到30分钟，注意休息", en: "Luteal: Return to 30 minutes, focus on rest" }
        ],
        priority: "low",
        ...
        resources: [
          {
            ...
            description: { zh: "追踪步行进度和成就", en: "Track walking progress and achievements" },
            type: "tool",
    ...
    const nutritionContents: RecommendationContent[] = [
      {
        ...
        actionSteps: [
          { zh: "增加深绿色蔬菜：菠菜、羽衣甘蓝每日150g", en: "Increase dark leafy greens: 150g spinach, kale daily" },
          { zh: "坚果和种子：杏仁、南瓜籽每日30g", en: "Nuts and seeds: 30g almonds, pumpkin seeds daily" },
          { zh: "全谷物：糙米、燕麦每日100g", en: "Whole grains: 100g brown rice, oats daily" },
          { zh: "黑巧克力：70%以上可可，每日20g", en: "Dark chocolate: 70%+ cocoa, 20g daily" }
        ],
        priority: "medium",
        ...
        resources: [
          {
            ...
            description: { zh: "含镁丰富的食物和食谱", en: "Magnesium-rich foods and recipes" },
            type: "recipe",
      ...
      },
      {
        id: "nutrition_omega3",
        type: "nutrition",
        title: { zh: "Omega-3脂肪酸抗炎方案", en: "Omega-3 Anti-inflammatory Plan" },
        description: { 
          zh: "通过Omega-3脂肪酸减少炎症反应，缓解经期疼痛。", 
          en: "Reduce inflammatory response through Omega-3 fatty acids to relieve menstrual pain." 
        },
        actionSteps: [
          { zh: "深海鱼：三文鱼、鲭鱼每周2-3次", en: "Deep-sea fish: Salmon, mackerel 2-3 times per week" },
          { zh: "亚麻籽：每日1汤匙研磨亚麻籽", en: "Flaxseeds: 1 tablespoon ground flaxseeds daily" },
          { zh: "核桃：每日5-8个核桃", en: "Walnuts: 5-8 walnuts daily" },
          { zh: "奇亚籽：可加入酸奶或沙拉，每日1汤匙", en: "Chia seeds: Add to yogurt or salad, 1 tablespoon daily" }
        ],
        priority: "medium",
        ...
        resources: [
          {
            ...
            description: { zh: "富含Omega-3的美味食谱", en: "Delicious recipes rich in Omega-3" },
            type: "recipe",
    ...
    const selfcareContents: RecommendationContent[] = [
      {
        ...
        actionSteps: [
          { zh: "薰衣草精油：3-5滴加入香薰机，帮助放松", en: "Lavender essential oil: 3-5 drops in diffuser for relaxation" },
          { zh: "洋甘菊精油：稀释后轻柔按摩腹部", en: "Chamomile essential oil: Diluted and gently massage abdomen" },
          { zh: "生姜精油：热敷时加入2-3滴，缓解痛经", en: "Ginger essential oil: Add 2-3 drops to heat pack for dysmenorrhea relief" },
          { zh: "玫瑰精油：泡澡时加入5-8滴，舒缓身心", en: "Rose essential oil: Add 5-8 drops to bath for body and mind soothing" }
        ],
        priority: "low",
        ...
        resources: [
          {
            ...
            description: { zh: "精油使用安全和注意事项", en: "Essential oil safety and precautions" },
            type: "article",
      ...
      },
      {
        ...
        actionSteps: [
          { zh: "艾草浴包：热水浸泡15-20分钟", en: "Mugwort bath bag: Soak in hot water for 15-20 minutes" },
          { zh: "生姜浴：切片生姜煮水后加入浴缸", en: "Ginger bath: Boil sliced ginger and add to bathtub" },
          { zh: "薰衣草浴：加入薰衣草精油和浴盐", en: "Lavender bath: Add lavender essential oil and bath salts" },
          { zh: "玫瑰花瓣浴：新鲜或干玫瑰花瓣浸泡", en: "Rose petal bath: Soak with fresh or dried rose petals" }
        ],
        priority: "medium",
        ...
        resources: [
          {
            ...
            description: { zh: "各种功效的草药浴配方", en: "Herbal bath recipes for various effects" },
            type: "recipe",
    ...
    const workplaceContents: RecommendationContent[] = [
      {
        ...
        type: "workplace",
        title: { zh: "办公环境人机工学调整", en: "Workplace Ergonomics Adjustment" },
        description: { 
          zh: "优化工作环境，减少身体压力，提升工作舒适度。", 
          en: "Optimize work environment to reduce physical stress and improve comfort." 
        },
        actionSteps: [
          { zh: "调整座椅高度：双脚平放，膝盖90度", en: "Adjust chair height: feet flat, knees at 90 degrees" },
          { zh: "显示器位置：屏幕顶部与视线齐平", en: "Monitor position: Screen top at eye level" },
          { zh: "腰部支撑：使用靠垫支撑下背部", en: "Lumbar support: Use cushion to support lower back" },
          { zh: "定时休息：每45分钟站立活动5分钟", en: "Regular breaks: Stand and move 5 minutes every 45 minutes" }
        ],
        priority: "medium",
        triggerConditions: ["assessment_complete"],
        targetAudience: { 
        ...
        resources: [
          {
            ...
            title: { zh: "办公室人机工学检查表", en: "Office Ergonomics Checklist" },
            description: { zh: "完整的工作环境优化清单", en: "Complete work environment optimization checklist" },
            type: "tool",
      ...
      },
      {
        ...
        type: "workplace",
        title: { zh: "职场压力管理技巧", en: "Workplace Stress Management Techniques" },
        description: { 
          zh: "在职场环境中有效管理压力，保持心理健康。", 
          en: "Effectively manage stress in workplace environment to maintain mental health." 
        },
        actionSteps: [
          { zh: "4-7-8呼吸法：吸气4秒，屏气7秒，呼气8秒", en: "4-7-8 breathing: Inhale 4s, hold 7s, exhale 8s" },
          { zh: "正念冥想：工作间隙5分钟专注呼吸", en: "Mindfulness meditation: 5 minutes focused breathing during work breaks" },
          { zh: "时间管理：使用番茄工作法提高效率", en: "Time management: Use Pomodoro technique to improve efficiency" },
          { zh: "界限设定：学会说\"不\"，保护个人时间", en: "Boundary setting: Learn to say \"no\" to protect personal time" }
        ],
        priority: "high",
        ...
        resources: [
          {
            ...
            title: { zh: "压力管理应用推荐", en: "Stress Management App Recommendations" },
            description: { zh: "适合职场人的减压工具", en: "Stress relief tools suitable for professionals" },
            type: "external",
    ...
    const emotionalContents: RecommendationContent[] = [
      {
        ...
        actionSteps: [
          { zh: "每日情绪记录：记录3种主要情绪和触发因素", en: "Daily emotion recording: Record 3 main emotions and triggers" },
          { zh: "身体感受觉察：注意情绪在身体的反应", en: "Body awareness: Notice physical reactions to emotions" },
          { zh: "感恩练习：每天记录3件感恩的事情", en: "Gratitude practice: Record 3 things you're grateful for daily" },
          { zh: "情绪反思：每周回顾情绪模式和变化", en: "Emotional reflection: Weekly review of emotional patterns and changes" }
        ],
        priority: "medium",
        triggerConditions: ["assessment_complete"],
        targetAudience: { 
        ...
        resources: [
          {
            ...
            description: { zh: "结构化的情绪记录模板", en: "Structured emotional recording template" },
            type: "tool",
      ...
      },
      {
        ...
        actionSteps: [
          { zh: "身体扫描冥想：10分钟全身觉察", en: "Body scan meditation: 10 minutes full body awareness" },
          { zh: "呼吸冥想：专注呼吸5-10分钟", en: "Breathing meditation: Focus on breathing 5-10 minutes" },
          { zh: "正念行走：缓慢步行，专注于每一步", en: "Mindful walking: Slow walking, focus on each step" },
          { zh: "慈心冥想：培养对自己的温柔关爱", en: "Loving-kindness meditation: Cultivate gentle self-care" }
        ],
        priority: "medium",
        triggerConditions: ["time_based", "assessment_complete"],
        targetAudience: { 
        ...
        resources: [
          {
            ...
            title: { zh: "正念冥想指导", en: "Mindfulness Meditation Guidance" },
            description: { zh: "适合初学者的正念练习指南", en: "Mindfulness practice guide for beginners" },
            type: "video",
    ...
    const medicalContents: RecommendationContent[] = [
      {
        ...
        actionSteps: [
          { zh: "NSAIDs药物：布洛芬或萘普生，按说明书使用", en: "NSAIDs: Ibuprofen or naproxen, use as directed" },
          { zh: "服药时机：疼痛开始前30分钟服用", en: "Timing: Take 30 minutes before pain starts" },
          { zh: "剂量控制：不要超过推荐剂量", en: "Dosage control: Do not exceed recommended dose" },
          { zh: "副作用监测：注意胃肠道不适和过敏反应", en: "Side effect monitoring: Watch for GI discomfort and allergic reactions" }
        ],
        priority: "high",
        triggerConditions: ["assessment_complete"],
        targetAudience: { 
        ...
        resources: [
          {
            ...
            title: { zh: "止痛药物安全使用指南", en: "Pain Medication Safety Guide" },
            description: { zh: "详细的药物使用说明和注意事项", en: "Detailed medication instructions and precautions" },
            type: "article",
      ...
      },
      {
        ...
        actionSteps: [
          { zh: "剧烈疼痛：影响日常生活和工作的疼痛", en: "Severe pain: Pain affecting daily life and work" },
          { zh: "异常出血：经量过大或经期不规律", en: "Abnormal bleeding: Excessive flow or irregular cycles" },
          { zh: "伴随症状：发热、头晕、严重恶心等", en: "Accompanying symptoms: Fever, dizziness, severe nausea" },
          { zh: "持续加重：症状逐月加重无缓解", en: "Progressive worsening: Symptoms worsening monthly without relief" }
        ],
        priority: "urgent",
        ...
        resources: [
          {
            ...
            description: { zh: "重要医疗资源和联系方式", en: "Important medical resources and contact information" },
            type: "external",
    ...
    const lifestyleContents: RecommendationContent[] = [
      {
        ...
        actionSteps: [
          { zh: "规律作息：每天同一时间入睡和起床", en: "Regular schedule: Sleep and wake at same time daily" },
          { zh: "睡前放松：避免电子屏幕，进行轻柔活动", en: "Pre-sleep relaxation: Avoid screens, engage in gentle activities" },
          { zh: "环境优化：保持卧室黑暗、安静、凉爽", en: "Environment optimization: Keep bedroom dark, quiet, cool" },
          { zh: "饮食注意：睡前3小时避免咖啡因和重餐", en: "Dietary caution: Avoid caffeine and heavy meals 3 hours before bed" }
        ],
        priority: "medium",
        triggerConditions: ["assessment_complete", "time_based"],
        targetAudience: { 
        ...
        resources: [
          {
            ...
            description: { zh: "监测和改善睡眠习惯", en: "Monitor and improve sleep habits" },
            type: "tool",
   ...
   * 按优先级获取推荐内容
   */
  public getContentsByPriority(priority: RecommendationPriority): RecommendationContent[] {
    return Array.from(this.contents.values()).filter(content => content.priority === priority);
  }
  ...
  public getContentsByCategory(category: string): RecommendationContent[] {
    return Array.from(this.contents.values()).filter(content => content.category === category);
  }
  ...
  public searchContents(query: string): RecommendationContent[] {
    ...
    return Array.from(this.contents.values()).filter(content => {
      ...
      return titleZh.includes(lowerQuery) || 
   ...
   * 更新推荐内容
   */
  public updateContent(id: string, updates: Partial<RecommendationContent>): boolean {
