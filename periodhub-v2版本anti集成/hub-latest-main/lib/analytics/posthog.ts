...
export type PaywallVariant = typeof PAYWALL_VARIANTS[keyof typeof PAYWALL_VARIANTS];
 ...
 * 记录A/B测试曝光
 */
export function trackABTestExposure(testName: string, variant: string, properties?: Record<string, unknown>) {
...
export function trackAssessmentQuestionAnswered(questionIndex: number, answer: number | string | boolean) {
...
// P1.2 付费墙A/B测试追踪
export function trackPaywallViewed(variant: string, painPoint: string, score: number) {
...
export function trackPaywallUpgradeClicked(variant: string, painPoint: string, plan: string) {
...
export function trackPaywallClosed(variant: string, painPoint: string, timeSpent: number) {
...
export function trackPlanSelected(variant: string, painPoint: string, plan: string) {
