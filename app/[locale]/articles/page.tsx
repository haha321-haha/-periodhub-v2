...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.periodhub.health/${locale}/articles`,
      languages: {
        'zh-CN': 'https://www.periodhub.health/zh/articles',
        'en-US': 'https://www.periodhub.health/en/articles',
        'x-default': 'https://www.periodhub.health/zh/articles',
      },
    },
    robots: {
      index: true,
...
export default async function ArticlesPage({
  ...
  const structuredData = {
    ...
    "url": `https://www.periodhub.health/${locale}/articles`,
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        {
        ...
        },
        {
          ...
          "position": 2,
          "name": locale === 'zh' ? "专业文章" : "Professional Articles",
          "item": `https://www.periodhub.health/${locale}/articles`
        }
      ]
    }
  };
