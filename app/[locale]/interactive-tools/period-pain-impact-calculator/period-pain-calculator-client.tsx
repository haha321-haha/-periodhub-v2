...
export default function PeriodPainCalculatorClient({ params }: PeriodPainCalculatorClientProps) {
  ...
  const isAssessmentComplete = result || (currentSession?.completedAt && currentSession?.result);
        ...
        <div className="min-h-[300px]">
          {currentQuestion && (
            <QuestionRenderer
              ...
              answer={currentSession.answers.find(a => a.questionId === currentQuestion.id)}
