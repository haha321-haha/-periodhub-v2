...
export const PainAssessmentToolClient = dynamic(() => import('./PainAssessmentTool'), {
  loading: () => <LoadingSystem.LoadingSpinner size="lg" />,
  ssr: false
});

export const SymptomChecklistClient = dynamic(() => import('./SymptomChecklist'), {
  loading: () => <LoadingSystem.LoadingSpinner size="lg" />,
  ssr: false
});
...
export const ComparisonTableClient = dynamic(() => import('./ComparisonTable'), {
  loading: () => <LoadingSystem.LoadingSpinner size="lg" />,
  ssr: false
});
