...
export default function ProgressTabs({ locale }: ProgressTabsProps) {
  ...
  const tabs = [
    ...
    { id: "week" as TabType, label: "This Week", icon: "📈" },
    { id: "month" as TabType, label: "This Month", icon: "📆" },
  ];
          ...
          {entries.length > 0 && (
            <div className="bg-gray-50 rounded-lg p-6 mb-8">
              <h3 className="font-semibold text-gray-800 mb-4">
                {activeTab === "all" && "Overall Statistics"}
                {activeTab === "today" && "Today's Summary"}
                {activeTab === "week" && "This Week's Summary"}
                {activeTab === "month" && "This Month's Summary"}
              </h3>
          ...
          {entries.length > 0 ? (
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                {activeTab === "all" && entries.length > 5 && (
                  <span className="text-sm text-gray-500">
                    Showing latest 5 of {entries.length}
                  </span>
                )}
              </div>
            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">
                {activeTab === "all" && "No Entries Yet"}
                {activeTab === "today" && "No Entries Today"}
                {activeTab === "week" && "No Entries This Week"}
                {activeTab === "month" && "No Entries This Month"}
              </h3>
              <p className="text-gray-600 mb-4">
                {activeTab === "all"
                  ? "Start tracking your stress management progress by adding your first entry."
                  : "Add an entry to start tracking your progress."}
              </p>
              <Link
