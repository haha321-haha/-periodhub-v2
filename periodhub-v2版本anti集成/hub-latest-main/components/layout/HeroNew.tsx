...
export default function HeroNew() {
  ...
  return (
    <section id="home" className="relative overflow-hidden pb-16 lg:pb-24 pt-24">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-4">
              <span className="font-semibold text-red-500 dark:text-red-400">{t('h2_prefix')}</span><br/>
              {t('h2_suffix')} <span className="font-semibold text-green-500 dark:text-green-400">{t('h2_highlight')}</span> {t('h2_end')}
            </p>
