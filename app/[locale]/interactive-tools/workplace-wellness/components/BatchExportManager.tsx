...
export default function BatchExportManager({ lang = 'zh' }: BatchExportManagerProps) {
  ...
  // 更新导出项目
  const handleUpdateExportItem = (itemId: string, updates: Partial<BatchExportItem>) => {
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {selectedItems.map((item) => (
                      <div key={item.id} className="flex items-center gap-4 p-3 border border-neutral-200 rounded-lg">
                        <div className="flex-1 grid grid-cols-3 gap-4">
                          <div>
                            ...
                            <input
                              type="text"
                              value={item.userName || ''}
                              onChange={(e) => handleUpdateExportItem(item.id, { userName: e.target.value })}
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => handleUpdateExportItem(item.id, { exportType: e.target.value as ExportType })}
                              className="w-full px-2 py-1 text-sm border border-neutral-300 rounded focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                            >
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => handleUpdateExportItem(item.id, { templateId: e.target.value })}
                              className="w-full px-2 py-1 text-sm border border-neutral-300 rounded focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                            >
