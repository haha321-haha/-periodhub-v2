...
import { ArrowLeft, RotateCcw, CheckCircle, AlertTriangle, Info } from 'lucide-react';
...
export default function ResultsScreen({ results, onRestart, onBack }: ResultsScreenProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
        ...
        {/* 评分卡片 */}
        <div className={`rounded-xl border-2 p-6 mb-8 ${getScoreColor(results.score)}`}>
