            ...
            <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4">
                        <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getPhaseColor(currentPhase)}`}>
                            <Sparkles className="w-4 h-4 mr-2" />
                            {content.title}
                        </div>
                        <div className="text-sm text-gray-500">
                            Energy Level: {content.energyLevel}/10
                        </div>
                    </div>

                    <h2 className="text-2xl font-bold text-gray-900 mb-2">
                        Today&apos;s Focus: {content.recommendations.work.focus}
                    </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-100 p-6 hover:shadow-md transition-shadow">
                    ...
                    <ul className="space-y-3">
                        {content.recommendations.work.tips.map((tip, index) => (
                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-100 p-6 hover:shadow-md transition-shadow">
                    ...
                    <ul className="space-y-3">
                        {content.recommendations.nutrition.foods.map((food, index) => (
                            <li key={index} className="flex items-start text-sm text-gray-600">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-100 p-6 hover:shadow-md transition-shadow">
                    <div className="flex items-center mb-4">
                        ...
                        <h3 className="font-semibold text-gray-900">Movement</h3>
                    </div>
                    <ul className="space-y-3">
                        {content.recommendations.exercise.activities.map((activity, index) => (
                            <li key={index} className="flex items-start text-sm text-gray-600">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-100 p-6 hover:shadow-md transition-shadow">
                    <div className="flex items-center mb-4">
                        ...
                        <h3 className="font-semibold text-gray-900">Daily Ritual</h3>
                    </div>
                    <p className="text-sm text-gray-600 italic">
                        &quot;{content.recommendations.selfCare.ritual}&quot;
                    </p>
                </div>
            </div>
