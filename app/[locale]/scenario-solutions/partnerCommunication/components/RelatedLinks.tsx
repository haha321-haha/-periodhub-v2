...
export default function RelatedLinks({
  ...
  const getRelevanceBadge = (relevance: string) => {
    switch (relevance) {
      case 'high':
        return { text: tCommon('highlyRelevant'), class: 'bg-primary-100 text-primary-800' };
      case 'medium':
        return { text: tCommon('moderatelyRelevant'), class: 'bg-blue-100 text-blue-800' };
      case 'low':
        return { text: tCommon('lowRelevance'), class: 'bg-neutral-100 text-neutral-800' };
      case 'required':
