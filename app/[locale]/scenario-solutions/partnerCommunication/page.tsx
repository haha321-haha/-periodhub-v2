...
export async function generateMetadata({
  ...
  const metadata = {
    zh: {
      ...
      description:
        "专业的伴侣沟通场景解决方案，包含理解度测试、30天训练营和个性化指导。帮助伴侣更好地理解痛经，提供针对性的沟通策略和情感支持技巧。基于循证医学的专业指导，适合各年龄段伴侣使用。",
      keywords:
    ...
    en: {
      ...
      description:
        "Professional partner communication scenario solutions with understanding test, 30-day training camp and personalized guidance. Help partners better understand period pain with targeted communication strategies and emotional support techniques.",
      keywords:
