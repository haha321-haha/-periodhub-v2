...
import { CurrentCycleInfo } from '../types';
...
const CycleViz: React.FC<CycleVizProps> = ({ cycleInfo }) => {
  ...
  const phaseColor = cycleInfo?.currentPhase?.color ?? '#06b6d4';
  ...
  return (
    <div className="relative flex items-center justify-center" aria-label={`Menstrual Cycle Visualization: Day ${currentDay}, ${currentPhaseName} Phase`}>
      {/* Decorative Glow */}
      ...
      <div className="relative z-10 w-[320px] h-[320px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="text-6xl font-bold text-purple-600 drop-shadow-sm">{currentDay}</div>
