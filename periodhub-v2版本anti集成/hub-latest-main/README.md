...
- 📖 [开发指南](./docs/DEVELOPMENT_GUIDE.md) - 环境设置、开发流程、代码规范
- 🚀 [部署指南](./docs/DEPLOYMENT_GUIDE.md) - 构建、部署步骤、环境变量配置
- 🌍 [翻译系统指南](./docs/TRANSLATION_KEY_MANAGEMENT_PROCESS.md) - 翻译键管理流程
