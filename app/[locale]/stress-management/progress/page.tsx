...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `${process.env.NEXT_PUBLIC_BASE_URL || "https://www.periodhub.health"}/${locale}/stress-management/progress`,
      languages: {
        'zh-CN': `${process.env.NEXT_PUBLIC_BASE_URL || "https://www.periodhub.health"}/zh/stress-management/progress`,
        'en-US': `${process.env.NEXT_PUBLIC_BASE_URL || "https://www.periodhub.health"}/en/stress-management/progress`,
        'x-default': `${process.env.NEXT_PUBLIC_BASE_URL || "https://www.periodhub.health"}/zh/stress-management/progress`,
      },
    },
    openGraph: {
      title: t('progress.title') + ' - PeriodHub',
  ...
  return (
    <>
      <StructuredData
        ...
        description={t('progress.subtitle')}
        url={`${process.env.NEXT_PUBLIC_BASE_URL || "https://www.periodhub.health"}/${locale}/stress-management/progress`}
      />
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                {t('progress.addEntry.subtitle')}
              </p>
            </div>

            <div className="grid md:grid-cols-4 gap-4 mb-6">
              {trackingFeatures.map((feature, index) => (
                <div key={index} className={`${feature.bgColor} rounded-lg p-4 text-center`}>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-white rounded-lg p-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">{t('progress.sampleData.averageStress')}</div>
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600 mb-1">85%</div>
                    <div className="text-sm text-gray-600">{t('progress.sampleData.techniquesUsed')}</div>
                  </div>
                </div>
                <div className="bg-white rounded-lg p-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-600 mb-1">6.8</div>
                    <div className="text-sm text-gray-600">{t('progress.sampleData.averageMood')}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl p-8 text-white mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2">{t('progress.benefits.insights.title')}</h3>
                <p className="text-purple-100 text-sm">{t('progress.benefits.insights.description')}</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-3">📊</div>
                <h3 className="font-semibold mb-2">{t('progress.benefits.trends.title')}</h3>
                <p className="text-purple-100 text-sm">{t('progress.benefits.trends.description')}</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-3">💪</div>
                <h3 className="font-semibold mb-2">{t('progress.benefits.motivation.title')}</h3>
                <p className="text-purple-100 text-sm">{t('progress.benefits.motivation.description')}</p>
              </div>
            </div>
          </div>
