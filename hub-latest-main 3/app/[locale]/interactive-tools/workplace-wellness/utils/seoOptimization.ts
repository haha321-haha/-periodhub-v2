...
export function getWorkplaceWellnessSEOData(): PageSEOData {
  return {
    zh: {
      ...
      description: '专业的职场健康管理工具，提供经期跟踪、疼痛管理、营养建议和工作调整方案。支持中英双语，保护隐私，提升工作效率。',
      keywords: [
        '职场健康',
        '经期管理',
        '疼痛跟踪',
      ...
      canonical: `${process.env.NEXT_PUBLIC_BASE_URL || 'https://www.periodhub.health'}/zh/workplace-wellness`,
      ogImage: '/images/workplace-wellness-og-zh.jpg',
    },
    en: {
      title: 'Workplace Wellness Assistant - Period Management & Work Optimization | Period Hub',
      description: 'Professional workplace wellness management tool providing period tracking, pain management, nutrition advice, and work adjustment solutions. Bilingual support, privacy protection, enhanced work efficiency.',
      keywords: [
        'workplace wellness',
        'period management',
        'pain tracking',
      ...
      canonical: `${process.env.NEXT_PUBLIC_BASE_URL || 'https://www.periodhub.health'}/en/workplace-wellness`,
...
export function generateFAQStructuredData(locale: Locale): any {
  const faqData = {
    zh: [
      {
        question: '职场健康助手是什么？',
        answer: '职场健康助手是专为职场女性设计的健康管理工具，提供经期跟踪、疼痛管理、营养建议和工作调整方案，帮助女性在职场中更好地管理健康。'
      },
      {
        question: '如何使用经期日历功能？',
        answer: '在经期日历中，您可以记录经期开始和结束日期、疼痛等级、流量情况等信息。系统会自动计算周期长度，并提供预测功能。'
      },
      {
        question: '营养建议如何个性化？',
        answer: '营养建议基于您当前的经期阶段和中医体质类型，提供个性化的食物推荐和膳食计划，帮助缓解经期不适。'
      },
      {
        question: '数据导出是否安全？',
        answer: '我们提供完整的数据脱敏和隐私保护机制，包括密码保护、数据脱敏、审计日志等功能，确保您的健康数据安全。'
      },
      {
        question: '支持哪些导出格式？',
        answer: '支持JSON、CSV、PDF三种格式导出，满足不同需求。PDF格式特别适合医疗报告，CSV适合数据分析，JSON适合数据备份。'
      }
    ],
    en: [
      {
        question: 'What is the Workplace Wellness Assistant?',
        answer: 'The Workplace Wellness Assistant is a health management tool designed specifically for working women, providing period tracking, pain management, nutrition advice, and work adjustment solutions to help women better manage their health in the workplace.'
      },
      {
        question: 'How to use the period calendar feature?',
        answer: 'In the period calendar, you can record period start and end dates, pain levels, flow conditions, and other information. The system automatically calculates cycle length and provides prediction functionality.'
      },
      {
        question: 'How is nutrition advice personalized?',
        answer: 'Nutrition advice is based on your current menstrual phase and TCM constitution type, providing personalized food recommendations and meal plans to help alleviate menstrual discomfort.'
      },
      {
        question: 'Is data export secure?',
        answer: 'We provide complete data masking and privacy protection mechanisms, including password protection, data masking, audit logs, and other features to ensure your health data security.'
      },
      {
        question: 'What export formats are supported?',
        answer: 'Supports JSON, CSV, and PDF export formats to meet different needs. PDF format is particularly suitable for medical reports, CSV for data analysis, and JSON for data backup.'
      }
    ]
  };
...
export function generateWebApplicationSchema(locale: Locale): any {
  const appData = {
    zh: {
      name: '职场健康助手',
      description: '专业的职场女性健康管理工具，提供经期跟踪、疼痛管理、营养建议和工作优化方案。',
    ...
    en: {
      ...
      description: 'Professional health management tool for working women, providing period tracking, pain management, nutrition advice, and work optimization solutions.',
      applicationCategory: 'HealthApplication',
      operatingSystem: 'Web Browser',
      offers: {
        '@type': 'Offer',
  ...
  return {
    ...
    url: `${process.env.NEXT_PUBLIC_BASE_URL || 'https://www.periodhub.health'}/${locale}/workplace-wellness`,
    author: {
      '@type': 'Organization',
      name: 'Period Hub',
 ...
 * 验证Meta信息长度
 */
export function validateMetaLength(title: string, description: string, locale: Locale): {
  isValid: boolean;
  issues: string[];
} {
  const issues: string[] = [];
  ...
  if (locale === 'zh') {
    ...
    if (description.length > 160) issues.push('中文描述过长，建议不超过160字符');
  } else {
