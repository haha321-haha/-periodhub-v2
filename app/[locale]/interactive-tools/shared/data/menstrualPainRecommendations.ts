  ...
  > = {
      ...
      qi_deficiency: [
        {
          ...
          description:
            "针对气虚体质的痛经特点，提供补气养血的中医调理方案，包括食疗、穴位按摩等。",
          category: "体质调理",
      ...
      yang_deficiency: [
        {
          ...
          description:
            "专门针对阳虚体质的痛经调理，重点介绍温阳散寒的方法和注意事项。",
          category: "体质调理",
          link: "/zh/interactive-tools/constitution-test",
        },
      ],
    ...
    en: {
      qi_deficiency: [
        {
          title:
            "Qi Deficiency Constitution Menstrual Pain Management: TCM Solutions for Qi and Blood Tonification",
          description:
            "Targeted TCM solutions for qi deficiency constitution menstrual pain, including dietary therapy and acupoint massage.",
      ...
      yang_deficiency: [
        {
          title:
            "Yang Deficiency Constitution Menstrual Pain Management: Warming Yang and Dispersing Cold",
          description:
            "Specialized care for yang deficiency constitution menstrual pain, focusing on warming yang and dispersing cold methods.",
          category: "Constitution Care",
          link: "/en/interactive-tools/constitution-test",
        },
      ],
      blood_stasis: [
        {
          title:
            "Blood Stasis Constitution Menstrual Pain Management: Effective Blood Circulation Methods",
          description:
            "Targeted solutions for blood stasis constitution menstrual pain, providing blood circulation and stasis resolution guidance.",
          category: "Constitution Care",
          link: "/en/interactive-tools/constitution-test",
        },
      ],
  ...
  en: {
    ...
    qi_deficiency: [
      ...
      },
      {
        ...
        items: [
          {
            name: "Jujube tea bags",
            reason: "Tonify qi and blood, relieve fatigue",
            priority: "high",
          },
          {
            name: "Heat pads",
